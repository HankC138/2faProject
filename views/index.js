...
const factorview = (user, hiddenphone, id) => html`<!DOCTYPE html>
	<html lang="en">
		...
		<body>
			<div>
				<h1 id="headOne">${hiddenphone}</h1>
				<form method="post" action="/auth/authorized">
					<div>
						<input
							type="text"
							id="code"
...
const success = html`<!DOCTYPE html>
	<html lang="en">
		<head>
			<meta charset="UTF-8" />
			<meta http-equiv="X-UA-Compatible" content="IE=edge" />
		...
		<body>
			<div>
				<h1 id="headOne">You've Been Validated</h1>
			</div>
		</body>
	</html>`;

module.exports = { signup, factorview, success };
